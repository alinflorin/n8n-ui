...
export const env = {
    ...
    API: window.location.href.includes("n8n.internal.huna2.com") ? '/webhook' : `https://${(import.meta.env.VITE_AUTH_USER || w.env.AUTH_USER)}:${(import.meta.env.VITE_AUTH_PASSWORD || w.env.AUTH_PASSWORD)}@n8n.internal.huna2.com/webhook`
};
